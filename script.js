...
document.addEventListener("DOMContentLoaded", () => {
  ...
  boxes.forEach(box => {
    let data = JSON.parse(localStorage.getItem(box.id)).keyStatus;
    if (data === "true") {
...
function addHabit() {
  ...
  let habitName = document.querySelector("#newHabit-name").value.toUpperCase();
